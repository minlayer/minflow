...
- The frontmatter is valid. The standard's reference tool, `skills-ref validate ./my-skill`, does exactly this and should run inside the compiler's build.
